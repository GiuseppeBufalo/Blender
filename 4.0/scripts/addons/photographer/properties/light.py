...
from ..operators.white_balance import convert_temperature_to_RGB_table
from ..operators import light_material
from ..constants import color_temp_desc, addon_name
...
def unit_scale_conversion(x):
    if bpy.context.preferences.addons[addon_name].preferences.follow_unit_scale:
...
def set_type(self, light_type):
    ...
    if self.gobo:
        light_material.update_gobo_area(self,None)
