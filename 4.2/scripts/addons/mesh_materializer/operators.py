...
_modifier_name = "Mesh Materializer Node v1.1"
    ...
    def execute(self, context):
        ...
        for source_object in source_objects:
            ...
            if hasattr(mod.node_group, 'inputs'):
                ...
                identifier = mod.node_group.interface.items_tree['Source Object'].identifier
            mod[identifier] = source_object

            if hasattr(mod.node_group, 'inputs'):
                identifier = mod.node_group.inputs['Target Object'].identifier
            else:
                identifier = mod.node_group.interface.items_tree['Target Object'].identifier
            ...
            if hasattr(mod.node_group, 'inputs'):
                ...
                identifier = mod.node_group.interface.items_tree['Target Object UV Map'].identifier
