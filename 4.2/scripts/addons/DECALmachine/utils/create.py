...
def render_thumbnail(context, decalpath, decal, decalmat, size=None, removeall=True):
    def set_emission_indicator(name):
        ...
        emission_input = dg.inputs.get('Emission' if bpy.app.version < (4, 0, 0) else 'Emission Color')
                ...
                if indicator:
                    ...
                    if not info_emits:
                        ...
                        if emission_amount == 0:
                            ...
                            pbr.inputs['Emission' if bpy.app.version < (4, 0, 0) else 'Emission Color'].default_value = (0, 0, 0, 1)
    ...
    if decalmat.DM.decaltype == "INFO":
        ...
        if decalmat.DM.decaltype == 'SUBSET':
            transmission = dg.inputs.get('Subset Transmission' if bpy.app.version < (4, 0, 0) else 'Subset Transmission Weight')
