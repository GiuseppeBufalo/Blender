...
from .. utils.ui import draw_init, draw_title, draw_prop, init_cursor, wrap_cursor, init_status, finish_status, draw_info, get_keymap_item, update_HUD_location
...
class Adjust(bpy.types.Operator):
    ...
    def modal(self, context, event):
        ...
        elif event.type in {'MIDDLEMOUSE'} or (self.is_alt_nav and event.alt and event.type in {'LEFTMOUSE', 'RIGHTMOUSE'}):
