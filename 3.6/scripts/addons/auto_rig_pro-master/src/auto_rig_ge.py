            ...
            for obj in bpy.data.objects:
                if "_arpexport" in obj.name:
                    if get_object(obj.name.replace("_arpexport", "")):
                        ...
                        base_obj.name = obj_name + "_arpbaseobject"
                        ...
                        if scn.arp_retro_ge_mesh == False and base_obj.data:
                            ...
                            base_obj.data.name = base_data_name + '_arpbaseobject'
            ...
            for obj in bpy.data.objects:
                if '_arpbaseobject' in obj.name:
                    if get_object(obj.name.replace('_arpbaseobject', '')):
                        ...
                        obj_export.name = obj_name + '_arpexport'
                        ...
                        if scn.arp_retro_ge_mesh == False and obj_export.data:
                            ...
                            obj_export.data.name = base_data_name + '_arpexport'
