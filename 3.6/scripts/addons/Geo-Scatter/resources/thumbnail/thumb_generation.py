...
class SCATTER5_OT_generate_thumbnail(bpy.types.Operator): #This is the same generator for preset and biomes. ui and argument are different tho. 
...
if __name__ == "__main__":
    ...
    argv = sys.argv
    if('--' not in argv):
        print("Error, We did not detect arguments?")
        sys.exit(1)
